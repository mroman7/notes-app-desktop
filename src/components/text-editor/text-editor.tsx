...
export default function TextEditor({ content, onContentChange}: { content: string, onContentChange: (newContent: string) => void }) {
  ...
  return (
    <div className="min-h-[calc(100vh-2rem)] w-full bg-transparent text-gray-900! dark:text-gray-100!">
      <MDXEditor
        ref={editorRef}
        markdown={content}
        onChange={onContentChange}
        placeholder="Start typing..."
        className="min-h-[calc(100vh-2rem)] w-full bg-transparent text-slate-900 dark:text-slate-100"
